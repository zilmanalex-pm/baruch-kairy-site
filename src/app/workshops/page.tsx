  ...
  return (
    <>
      ...
      <div className="relative">
        <DecorativeCircle className="absolute hidden lg:block z-[1] left-[-30px] top-[-20px]" design="swirl-arcs" color="orange" size={420} animation="spin-slow" opacity={0.7} />
        <div className="relative">
      ...
      <ScrollReveal>
      <div className="relative">
        <DecorativeCircle className="absolute hidden lg:block z-[1] right-[-100px] bottom-[-80px]" design="spirograph" color="teal" size={380} animation="spin-slow" opacity={0.7} />
        <div className="relative">
          <Section background="bg">
