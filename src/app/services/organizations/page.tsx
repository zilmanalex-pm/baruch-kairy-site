  ...
  return (
    <>
      ...
      <div className="relative bg-subtle-bg">
        <DecorativeCircle className="absolute hidden lg:block z-[1] left-[-100px] top-[10%]" design="spirograph" color="teal" size={350} animation="spin-slow" opacity={0.7} />
      ...
      <div className="relative bg-bg">
        <DecorativeCircle className="absolute hidden lg:block z-[1] right-[-80px] top-[25%]" design="diagonal-lines" color="orange" size={280} animation="spin-slow" opacity={0.7} />
        <div className="relative z-[2]">
          <Section background="none">
      ...
      <ScrollReveal>
      <div className="relative bg-subtle-bg">
        <DecorativeCircle className="absolute hidden lg:block z-[1] left-[-80px] top-[15%]" design="dots-dense" color="teal" size={280} animation="spin-slow" opacity={0.7} />
        <div className="relative z-[2]">
          <Section background="none">
